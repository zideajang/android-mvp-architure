...
import arch.zidea.com.android_mvp_arch.di.component.DaggerActivityComponent;
import arch.zidea.com.android_mvp_arch.di.module.ActivityModule;
import arch.zidea.com.android_mvp_arch.utils.CommonUtils;
import arch.zidea.com.android_mvp_arch.utils.NetworkUtils;
...
//        mActivityComponent = mActivityComponent
        mActivityComponent = DaggerActivityComponent.builder()
                .activityModule(new ActivityModule(this))
                .applicationComponent(((ZiApp) getApplication()).getComponent())
                .build();
    }
    ...
    private void showSnackBar(String messsage){
        Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content),messsage,Snackbar.LENGTH_SHORT);
